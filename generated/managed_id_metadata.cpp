...
defcolor_index_function = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_index_function"));
defcolor_index_macro = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_index_macro"));
defcolor_index_type = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_index_type"));
defcolor_pop3 = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_pop3"));
defcolor_file_unsaved = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_file_unsaved"));
defcolor_file_unloaded = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_file_unloaded"));
