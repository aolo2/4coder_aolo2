...
CUSTOM_ID(colors, defcolor_index_function);
CUSTOM_ID(colors, defcolor_index_macro);
CUSTOM_ID(colors, defcolor_index_type);

CUSTOM_ID(colors, defcolor_pop3);
CUSTOM_ID(colors, defcolor_file_unsaved);
CUSTOM_ID(colors, defcolor_file_unloaded);
